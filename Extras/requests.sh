...
./client -i 1 -a 127.0.0.1 -p 9090 -o Extras/query1.txt > Outputs/c6.txt &
./client -i 2 -a 127.0.0.1 -p 9090 -o Extras/query1.txt > Outputs/c7.txt &
./client -i 3 -a 127.0.0.1 -p 9090 -o Extras/query1.txt > Outputs/c8.txt &
./client -i 4 -a 127.0.0.1 -p 9090 -o Extras/query1.txt > Outputs/c9.txt &
./client -i 5 -a 127.0.0.1 -p 9090 -o Extras/query1.txt > Outputs/c10.txt